...
namespace SplitEngine::Rendering::Vulkan
{
		...
		DeviceObject(device)
	{
		...
		constexpr vk::AttachmentReference depthAttachmentReference = vk::AttachmentReference(1, vk::ImageLayout::eDepthStencilAttachmentOptimal);

		vk::SubpassDescription subpass = vk::SubpassDescription({}, vk::PipelineBindPoint::eGraphics, {}, colorAttachmentReference, {}, &depthAttachmentReference);
		...
		const vk::RenderPassCreateInfo         renderPassCreateInfo = vk::RenderPassCreateInfo({}, attachments, subpass, subpassDependency);
