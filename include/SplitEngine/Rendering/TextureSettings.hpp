...
namespace SplitEngine::Rendering
{
	struct TextureSettings
	{
		public:
			...
			{
				return MagnificationFilter == other.MagnificationFilter && MinificationFilter == other.MinificationFilter && MipmapMode == other.MipmapMode &&
					   WrapMode == other.WrapMode && MipLodBias == other.MipLodBias && MinLod == other.MinLod && MaxLod == other.MaxLod &&
