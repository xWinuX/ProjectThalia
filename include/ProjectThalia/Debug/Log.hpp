...
#define PRIVATE_LOG_FORMAT(type, message, ...) ProjectThalia::Debug::Log::type(std::format(message, __VA_ARGS__), __FILE__, __LINE__)
#define PRIVATE_LOG(type, message) ProjectThalia::Debug::Log::type(message, __FILE__, __LINE__)
